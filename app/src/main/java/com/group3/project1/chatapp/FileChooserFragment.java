...
public class FileChooserFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, final Bundle savedInstanceState) {
        ...
        this.textViewBrowse = (TextView) rootView.findViewById(R.id.textBrowse);

        this.textViewBrowse.setOnClickListener(new View.OnClickListener() {
        ...
        Button btnSave = (Button) rootView.findViewById(R.id.btnProfileImageSave);
        Button btnCancel = (Button) rootView.findViewById(R.id.btnProfileImageCancel);
